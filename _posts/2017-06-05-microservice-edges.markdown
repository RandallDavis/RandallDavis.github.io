...
I propose that intelligent fakes should be shipped along with microservice contracts to simulate microservice edge behavior, and that the proper practices be put in place to ensure those fakes' validity and testing coverage. The glue between microservices interactions is the flimsiest part of microservice architectures, and this directly addresses the ambiguities that currently seem to be prevalent.
